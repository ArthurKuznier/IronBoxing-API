...
public class AtletaController {
    ...
    @PostMapping
    @Operation(summary = "Criar perfil de atleta", description = "Associa um perfil de atleta a uma conta de usuÃ¡rio existente. Rota protegida.")
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Perfil de atleta criado com sucesso"),
        @ApiResponse(responseCode = "400", description = "Dados invÃ¡lidos fornecidos ou UsuÃ¡rio jÃ¡ associado"),
    ...
    @PutMapping("/{id}")
    @Operation(summary = "Atualizar perfil de atleta", description = "Atualiza os dados de um perfil de atleta especÃ­fico pelo ID. Rota protegida.")
    @ApiResponses({
    ...
    @GetMapping
    @Operation(summary = "Listar todos os atletas", description = "Retorna a lista de todos os atletas cadastrados e seus respectivos dados de usuÃ¡rio. Rota protegida.")
    @ApiResponses({
    ...
    @ApiResponses({
        ...
        @ApiResponse(responseCode = "403", description = "Acesso negado - requer token JWT vÃ¡lido"),
        @ApiResponse(responseCode = "404", description = "Atleta nÃ£o encontrado")
    })
    ...
    @Operation(summary = "Buscar atleta por e-mail", description = "Localiza o atleta pelo e-mail do seu usuÃ¡rio. Rota protegida.")
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Atleta localizado e retornado"),
        @ApiResponse(responseCode = "403", description = "Acesso negado - requer token JWT vÃ¡lido"),
        @ApiResponse(responseCode = "404", description = "Atleta nÃ£o encontrado com o e-mail informado")
    })
    ...
    @GetMapping("/cpf/{cpf}")
    @Operation(summary = "Buscar atleta por CPF", description = "Localiza o atleta pelo CPF do seu usuÃ¡rio. Rota protegida.")
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Atleta localizado e retornado"),
        @ApiResponse(responseCode = "403", description = "Acesso negado - requer token JWT vÃ¡lido"),
        @ApiResponse(responseCode = "404", description = "Atleta nÃ£o encontrado com o CPF informado")
    })
    ...
    @Operation(summary = "Buscar atleta por telefone", description = "Localiza o atleta pelo telefone do seu usuÃ¡rio. Rota protegida.")
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Atleta localizado e retornado"),
        @ApiResponse(responseCode = "403", description = "Acesso negado - requer token JWT vÃ¡lido"),
        @ApiResponse(responseCode = "404", description = "Atleta nÃ£o encontrado com o telefone informado")
    })
    ...
    @Operation(summary = "Listar atletas por gÃªnero", description = "Retorna uma lista de atletas baseada no gÃªnero associado (M/F/O). Rota protegida.")
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Lista retornada com sucesso"),
        @ApiResponse(responseCode = "403", description = "Acesso negado - requer token JWT vÃ¡lido")
    })
    ...
    @Operation(summary = "Buscar atleta por ID do UsuÃ¡rio", description = "Localiza o perfil de atleta associado ao ID da conta de usuÃ¡rio correspondente. Rota protegida.")
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Atleta localizado e retornado"),
        @ApiResponse(responseCode = "403", description = "Acesso negado - requer token JWT vÃ¡lido"),
        @ApiResponse(responseCode = "404", description = "Atleta nÃ£o encontrado para o usuÃ¡rio informado")
    })
